...
const example: Registry = [
  ...
  },
  {
    ...
    type: "components:example",
    registryDependencies: ["button-group", "button"],
    files: ["example/button-group-separator.tsx"],
  },
  {
    name: "button-group-outline",
    type: "components:example",
    registryDependencies: ["button-group", "button", "select"],
    files: ["example/button-group-outline.tsx"],
  },
  {
    name: "button-group-vertical",
    type: "components:example",
    registryDependencies: ["button-group", "button"],
    files: ["example/button-group-vertical.tsx"],
  },
  {
    name: "button-group-separator-vertical",
    type: "components:example",
    registryDependencies: ["button-group", "button"],
    files: ["example/button-group-separator-vertical.tsx"],
  },
  {
    name: "calendar-demo",
    type: "components:example",
